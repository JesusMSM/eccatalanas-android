...
public class PieChartRendererEC extends PieChartRenderer {
    ...
    public PieChartRendererEC(PieChartEC chart, ChartAnimator animator,
    ...
    public void drawData(Canvas c) {
        ...
        int height = (int) (mViewPortHandler.getChartHeight() + mViewPortHandler.getChartHeight()/5);
